...
import (
	...
	"github.com/NLGRF/ChainBridge/bindings/Bridge"
	"github.com/NLGRF/ChainBridge/bindings/ERC20Handler"
	"github.com/NLGRF/ChainBridge/bindings/ERC721Handler"
	"github.com/NLGRF/ChainBridge/bindings/GenericHandler"
	utils "github.com/NLGRF/ChainBridge/shared/ethereum"
	ethtest "github.com/NLGRF/ChainBridge/shared/ethereum/testing"
	"github.com/NLGRF/chainbridge-utils/blockstore"
