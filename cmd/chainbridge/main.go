...
For configuration and CLI commands see the README: https://github.com/NLGRF/ChainBridge.
*/
package main
...
import (
	...
	"github.com/NLGRF/ChainBridge/chains/ethereum"
	"github.com/NLGRF/ChainBridge/chains/substrate"
	"github.com/NLGRF/ChainBridge/config"
	"github.com/NLGRF/chainbridge-utils/core"
	"github.com/NLGRF/chainbridge-utils/metrics/health"
